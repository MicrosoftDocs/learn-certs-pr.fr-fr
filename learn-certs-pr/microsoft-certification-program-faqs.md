...
### Profil de certification Microsoft
...
1. [Comment puis-je contacter l’assistance au programme de certification Microsoft ?](#d1)

<br/>

## programme de certification Microsoft
...
1. Visitez le site [Microsoft Learning](https://www.microsoft.com/learning/)
2. Sélectionnez votre [Tableau de bord](https://www.microsoft.com/learning/dashboard.aspx) dans la barre de navigation supérieure
3. Connectez-vous avec le compte Microsoft (ID de Windows Live) et le mot de passe que vous avez utilisé pour créer votre profil de certification Microsoft.
...
**Q: Où puisje trouver le numéro d’identification de mon profil de certification Microsoft (MCID) ?**<a name="a2"></a>

**R:** Pour trouver votre numéro d’identification de certification Microsoft (MCID) connectez-vous à votre [tableau de bord de certification](https://www.microsoft.com/learning/dashboard.aspx). Votre ESPRIT est situé sur la droite.<br/><br/>
...
1. Connectez-vous à votre [tableau de bord de certification](https://www.microsoft.com/learning/dashboard.aspx)
...
**R:** Si vous avez besoin de modifier votre nom sur votre profil de certification Microsoft, contactez [L’assistance à la certification](https://aka.ms/mcpforum). Un modérateur du forum vous répondra dans un délai de 24 heures ouvrables. Vous devrez confirmer les informations contenues dans votre profil de certification Microsoft avant de pouvoir exécuter la modification de nom. Rappelez-vous que le nom sur votre profil de certification Microsoft doit correspondre exactement au nom qui apparaît sur votre document d’identification émis par le gouvernement que vous utiliserez lorsque vous passerez votre examen de certification Microsoft. Consultez la [Politique relative à l’identité de Pearson VUE ](https://home.pearsonvue.com/Policies/1S/English) pour en savoir plus.

<br/>

**Q: Comment puis-je accéder à mon transcription de certification Microsoft?**<a name="a9"></a>

**R:**
1. Pour accéder à votre relevé de notes, connectez-vous à votre [tableau de bord de certification](https://www.microsoft.com/learning/dashboard.aspx)
2. Cliquez sur l'icône ** Transcription ** du tableau de bord<br/><br/>
...
**R:**
1. Pour trouver vos certificats, connectez-vous à votre [tableau de bord de certification](https://www.microsoft.com/learning/dashboard.aspx)
