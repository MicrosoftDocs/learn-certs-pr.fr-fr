---
title: À propos des examens en ligne | Microsoft Docs
...
---
# À propos des examens en ligne

Vous pouvez passer n’importe quel examen des Fundamentals ou basé sur les rôles (fourni par Pearson VUE) en ligne dans le confort de votre maison ou de votre bureau tout en étant observé par un surveillant grâce à la webcam et un micro. (Cet article ne concerne pas les examens fournis par Certiport) Si vous souhaitez passer un examen en ligne par l'intermédiaire de Pearson VUE et que vous vouliez savoir à quoi vous attendre avant de vous inscrire, cette page expliquera les détails. Vous pouvez également regarder la vidéo [vidéo YouTube](https://youtu.be/Gm1PqdbwBP0) de Pearson VUE.


# Choisir une épreuve portant sur le système
...
[Épreuve système maintenant](https://service.proctorcam.com/system_test?customer=pearson_vue&clientcode=MICROSOFT)
...
2. **Confirmez que votre identité est conforme (lisez les [exigences](https://home.pearsonvue.com/Policies/1S/English)) et que le nom figurant sur votre profil correspond exactement à votre identification.**  
...
Le nom figurant sur votre pièce d'identité doit être identique au nom de votre profil Microsoft et Pearson VUE.
...
- Vous ne serez autorisé ni à copier ni à enregistrer des questions ou des réponses à l’examen, par quelque moyen que ce soit, ni à partager ou parler des questions ou des réponses vues lors de l’examen avec d’autres.
- En passant cette épreuve, vous admettez que le surveillant vous observera par vidéo et audio, et vous admettez et consentez à l’enregistrement audio et vidéo de votre visage, de votre voix, de l’endroit où vous vous trouvez et du lieu de livraison de l’examen. Vous reconnaissez qu'aucun droit au respect de la vie privée ne s'applique durant l'épreuve par rapport à votre emplacement et que vous renoncez à toute revendication relative au respect de la vie privée. Si vous ne souhaitez pas faire l'objet d'un enregistrement (vidéo ou audio), veuillez avertir immédiatement le surveillant que vous ne souhaitez pas passer l'examen.
...
- Connectez-vous à [votre tableau de bord de certification](https://www.microsoft.com/learning/dashboard.aspx).
- Dans la section **Rendez-vous** ; sur la droite, choisissez **Commencer un examen surveillé en ligne précédemment programmé**.
- L’examen que vous avez programmé devrait apparaître. Sélectionnez le lien de l’examen puis choisissez **Commencez l’examen**.

**Remarque** Vous devrez éventuellement patienter jusqu’à cinq minutes avec d’être mis en relation avec l'agent d'accueil.

Une fois en relation avec votre agent d'accueil:

- Ayez votre permis de conduire, passeport ou toute autre pièce d’identité disponible afin que votre identité puisse être vérifiée.
- L'agent d'accueil passera en revue votre comportement/conduite lors de l’examen, ainsi que la procédure de communication pendant le déroulement de ce dernier. Toute communication avec l'agent d'accueil et le surveillant se fera dans la langue que vous avez sélectionnée pendant l’inscription (elle peut être différente de la langue dans laquelle vous passez l’examen).
- Il vous sera demandé de fermer toutes les applications non essentielles (courriel ou application de conversation, par exemple).
...
En cas de problème après l'examen, contactez Pearson VUE. Munissez-vous du numéro de rapport d'incident fourni par votre surveillant.

### Récupérer le relevé de notes et désinstaller le logiciel du surveillant

Vous pouvez accéder à vos relevés de notes à partir de [votre tableau de bord de certification](https://www.microsoft.com/learning/dashboard.aspx).

- Connectez-vous à [votre tableau de bord de certification](https://www.microsoft.com/learning/dashboard.aspx).
- Sélectionnez **Afficher mon relevé de notes**. Dans cette fenêtre, vous pouvez enregistrer et imprimer votre relevé de notes.
- Vos résultats (réussite ou échec) seront transmis à Microsoft pour traitement.
- À l’issue de votre examen, vous serez tenu de supprimer tous les fichiers exécutables et accessoires, notamement l’icône **Pearson VUE Secure Browser**. Pour faire disparaître cette icône de votre bureau, cliquez droit dessus et choisissez **Delete** puis **Yes**.
- **[Désinstaller le fichier exécutable pour Pearson VUE Secure Browser](https://windows.microsoft.com/en-us/windows7/uninstall-or-change-a-program)**.
...
Commencez par vous assurer que votre ordinateur remplit les conditions requises en effectuant le [test système](https://service.proctorcam.com/system_test?customer=pearson_vue&clientcode=MICROSOFT) demandé. Consultez la page plus haut pour savoir à quoi vous attendre quant au protocole d’examen. Si vous avez un doute ou des réserves, nous vous conseillons de planifier votre examen dans un centre d'examens.

### Puis-je quand même passer un examen en ligne si mon système ne passe pas ce test ?
Non. Vous ne devez pas vous inscrire pour un examen en ligne si votre système ne passe pas le test du système. Vous ne devez pas non plus prévoir un examen en ligne si vous ne pouvez pas prendre une photo claire de votre pièce d’identité.
...
Vous disposerez de la même durée si vous passez l'examen en ligne que si vous le passez dans un centre d'examens Pearson VUE.
...
Veuillez consulter la [politique d’identification](https://home.pearsonvue.com/Policies/1S/English) en vigueur. Si vous êtes en train de mettre à jour ou de renouveler votre pièce d'identité, notez que les formulaires juridiques de changement de nom, y compris les formulaires de renouvellement de la carte d'identité, seront refusés pour les examens surveillés en ligne.

### Comment modifier mon nom officiel ?
Votre nom doit correspondre strictement à celui fourni à l'inscription. Après avoir enregistré votre profil d’inscription à l’examen, vous ne pouvez modifier votre nom légal qu’en demandant de l’aide par le biais de nos forums modérés d’assistance à la certification.

### J’ai un rendez-vous prévu pour un examen en ligne. Comment puis-je le commencer ?
Vous disposez d'un délai de 15 minutes passé l'heure programmée pour commencer l'examen. Toutefois, une fois ce délai écoulé, vous ne serez plus autorité à commencer le processus d’examen.

Pour commencer votre examen, connectez-vous à [votre tableau de bord de certification](https://www.microsoft.com/learning/dashboard.aspx) et cliquez sur **Démarrer un examen surveillé en ligne précédemment planifié**. Vous serez redirigé vers une page Pearson VUE sur laquelle l'examen programmé est visible. Vous pouvez commencer l'examen.
